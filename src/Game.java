...
public class Game {
	...
	public void playGame() {
		...
		while (!gameIsOver()) {
			...
			findCheckmate();} // End White's turn
			if (gameIsOver()) {
				break;
			} else {
				// Black's turn
	...
	private void continueTurn(Player pl) {
		...
		// postcondition: Piece has been moved from fromPos to toPos on the Board// Provide feedback to user
	...
	private Position chooseDestination() {
		...
		System.out.println();return toPos;
	}
