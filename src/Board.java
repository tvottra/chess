...
public class Game {
	 ...
	 * Method is incomplete; must find a way to use findKingPosition() on the copy of the board <-- TODO: FIXED? Remove this comment?
	 */
	public void findCheckMate() {

		for (int color = 0; color < 2; color++) {
			if (gameBoard.isKingChecked(color, gameBoard.getBoard())) {
				Position kingPos = gameBoard.findKingPosition(color, gameBoard.getBoard());
